...
- (BOOL)hasValue:(NSString*)string
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [spaceCharSet formUnionWithCharacterSet:[NSMutableCharacterSet characterSetWithCharactersInString:NON_BREAKING_SPACE]];
...
{
    if (!DIGIT_MAPPINGS) {
        DIGIT_MAPPINGS = [[NSDictionary alloc] initWithObjectsAndKeys:
